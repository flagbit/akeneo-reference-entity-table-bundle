...
namespace spec\Flagbit\Bundle\ReferenceEntityTableBundle\Connector\ArrayConverter\StandardToFlat;
...
class RecordSpec extends ObjectBehavior
{
    ...
    public function it_is_an_array_converter()
    {
        $this->shouldImplement(ArrayConverterInterface::class);
    }

    public function it_is_a_record_array_converter()
    {
        $this->shouldHaveType(Record::class);
    }

    public function it_converts_a_normalized_record_and_skips_identifier()
    {
        $normalizedRecord = [
    ...
    public function it_converts_a_text_value(
    ...
    public function it_converts_a_number_value(
        AttributeRepositoryInterface $attributeRepository,
    ...
    public function it_converts_an_option_value(
        AttributeRepositoryInterface $attributeRepository,
    ...
    public function it_converts_an_option_collection_value(
        AttributeRepositoryInterface $attributeRepository,
    ...
    public function it_converts_a_record_collection_value(
        AttributeRepositoryInterface $attributeRepository,
    ...
    public function it_converts_a_record_value(
        AttributeRepositoryInterface $attributeRepository,
    ...
    public function it_converts_a_media_file_value(
        AttributeRepositoryInterface $attributeRepository,
    ...
    public function it_generates_keys_for_localizable_attributes(
        AttributeRepositoryInterface $attributeRepository,
        TextAttribute $textAttribute
    ) {
        $textAttribute->getType()->willReturn(TextAttribute::ATTRIBUTE_TYPE);
    ...
    public function it_generates_keys_for_scopable_attributes(
        AttributeRepositoryInterface $attributeRepository,
        TextAttribute $textAttribute
    ) {
        $textAttribute->getType()->willReturn(TextAttribute::ATTRIBUTE_TYPE);
    ...
    public function it_generates_keys_for_scopable_and_localizable_attributes(
        AttributeRepositoryInterface $attributeRepository,
        TextAttribute $textAttribute
    ) {
        $textAttribute->getType()->willReturn(TextAttribute::ATTRIBUTE_TYPE);
    ...
    public function it_converts_a_table_value(
        AttributeRepositoryInterface $attributeRepository,
        TableAttribute $tableAttribute
    ) {
        $tableAttribute->getType()->willReturn(TableAttribute::ATTRIBUTE_TYPE_NAME);
        $tableAttribute->hasValuePerChannel()->willReturn(false);
        $tableAttribute->hasValuePerLocale()->willReturn(false);
        $tableAttribute->getCode()->willReturn(AttributeCode::fromString('table'));
        $attributeRepository->getByIdentifier(AttributeIdentifier::fromString('table_table_f788c965-7e69-499d-a25d-cce39f45249b'))
            ->willReturn($tableAttribute);

        $normalizedRecord = [
            'identifier' => 'table_identifier',
            'code' => 'table_code',
            'referenceEntityIdentifier' => 'table',
            'values' => [
                'table_table_f788c965-7e69-499d-a25d-cce39f45249b' => [
                    'attribute' => 'table_table_f788c965-7e69-499d-a25d-cce39f45249b',
                    'channel' => null,
                    'locale' => null,
                    'data' => [
                        [
        ...
        $this->convert($normalizedRecord)->shouldReturn(
            [
                'code' => 'table_code',
                'referenceEntityIdentifier' => 'table',
                'table' => '[{"test":"foo","test2":"545.5454","test3":"test2"},{"test":"bar","test2":"8786","test3":null}]',
            ]
        );
    }
}
